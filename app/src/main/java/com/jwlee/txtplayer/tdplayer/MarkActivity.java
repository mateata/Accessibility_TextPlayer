...
public class MarkActivity extends TDBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p_mark);
        
        mContext = this;
		
        setView();
        
		int[] resIDs = {R.id.popup_memo_btn_ok, R.id.popup_memo_btn_cancel };
    ...
    private void setView(){
    	...
    	edit_SN = (EditText)findViewById(R.id.popup_memo_edit_sn);
    	btn_Ok = (Button)findViewById(R.id.popup_memo_btn_ok);
    	btn_Ok.setOnClickListener(mBtn_ClickListener);
    	btn_Cancel = (Button)findViewById(R.id.popup_memo_btn_cancel);
